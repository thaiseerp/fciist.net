...
<link href="<?=base_url();?>contents/css/dataTables.tableTools.min.css" rel="stylesheet" type="text/css" media="all"/>
    ...
    <div class="content">
        <div class="box">
            <div class="box-head">
                <h3>Booking Status - South Indian Lunch</h3>
            </div>
        <div style="padding:20px">
            <table id="users_table" class="display cell-border" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th colspan="4">South Indian Lunch Booking for <?php echo($date->format('l, F dS, Y')); ?></th>
                    </tr>
                    <tr>
                        <th>#</th>
                        <th>Name</th>
                ...
                if($users)
                {
                    foreach($users as $row){
                        ...
                        echo "<tr>";
                            ...
                            echo "<td><label for='timestamp'>".htmlspecialchars(date("h:i:s A", strtotime($row['timestamp'])))."</td>";
                        echo "</tr>";
                    }
                }
