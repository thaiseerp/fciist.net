...
class Ion_auth
{
	 ...
	 * @author Mathew
	 **/
	public function register($email, $password,$additional_data = array(), $group_ids = array()) //need to test email activation
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

		$id = $this->ion_auth_model->register($email, $password,$additional_data, $group_ids);
